...
if (isset($_POST['submit'])) {
   ...
   echo "<script> window.location.href='food/checkout.php'</script>";
}
?>
         ...
         <?php if (is_array($cart_items) || is_object($cart_items)) : ?>
            <?php foreach ($cart_items as $cart_item) : ?>
               <tr>
                  ...
                  <td><a href="<?php echo APPURL; ?>/food/delete-item.php?id=<?php echo $cart_item->id ?>" class="btn btn-danger">DELETE</a></td>
               </tr>
            <?php endforeach; ?>
         <?php else : ?>
            <tr>
